export const ReportedApi={
    ...
    API:{
        ...
        GET_SUM_WITH_CATEGORIES_GROUPED_BY_MONTH:"/api/HR_BangLuong/GetSumCategoriesGroupByMonth",
        GET_COUNTED_HR_GROUPED_BY_MONTH:"/api/HR_BangLuong/GetCountedHRGroupByMonth",
        GET_COUNTED_ALL_NEW_HR_GROUPED_BY_MONTH:"/api/HR_BangLuong/GetCountedAllNewHRGroupByMonth",
        GET_COUNTED_ALL_QUITED_HR_GROUPED_BY_MONTH:"/api/HR_BangLuong/GetCountedAllQuitedHRGroupByMonth",
        //DOANH THU THUC TE
