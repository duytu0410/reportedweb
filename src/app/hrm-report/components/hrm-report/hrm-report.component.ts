...
export class HrmReportComponent implements OnInit,OnDestroy {
  ...
  onSubmit(data){
    console.log(data)
    this.hrmReportService.body=data;
    ...
    console.log(this.hrmReportService.body)
    let nam=this.hrmReportService.body.nam;
    let thang=this.hrmReportService.body.thang;
          ...
          //hết dash 2
            ...
            //heest dash11
                 ...
                 if(data3.length=data12.length=data12a.length){
                  ...
                  this.getdifferenteachmonth[0].name="Tăng trưởng so với tháng trước năm "+this.hrmReportService.nam;
             ...
             //dash 8
              for (let i = 0; i < data.length; i++) {
                ...
                this.getsumwithcategorieseachmonth[i].series[0].name=this.hrmReportService.nam.toString();
